...
def main():
    ...
    parser.add_argument('--test_label_json', type=str, default='data/testing_public_label.json',
                        help='json file of testing captions and corresponding video id')
    parser.add_argument('--result_file', type=str, default='data/testing_predicted_label.json',
                        help='result file')
